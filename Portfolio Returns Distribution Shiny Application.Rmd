...
renderPlot({
  ...
  panel.grid.major = element_line(size = 0.025, linetype = 'solid',
                                colour = "white"), 
  panel.grid.minor = element_line(size = 0.025, linetype = 'solid',
                                colour = "white")) +
    geom_histogram(alpha = 0.90, binwidth = .01, fill = "yellow")
})
```
...
renderPlot({
  ...
  panel.grid.minor = element_line(size = 0.025, linetype = 'solid',
                                colour = "white")) +
  geom_density(size = 2, color = "purple") 
})
```
...
renderPlot({
  ...
  panel.grid.minor = element_line(size = 0.025, linetype = 'solid',
                                colour = "white")) +
    geom_histogram(alpha = .90, binwidth = .01, fill = "yellow") +
    geom_density(geom = "line", size = 2, color = "purple")
})
```